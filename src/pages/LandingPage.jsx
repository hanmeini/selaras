...
const LandingPage = () => {
  return (
    <section id='landingpage' className='overflow-x-hidden'>
        {/* home */}
        <section id='home' style={{ backgroundImage: `url(${bgHome})` }} className="flex flex-col pt-20 bg-cover bg-center bg-no-repeat h-full">
        ...
        {/* about */}
        <section id='about' className='min-h-screen min-w-screen flex items-center justify-center relative'>
